...
import web.controlevacinacao.repository.queries.vacina.lote.LoteQueriesImpl;
...
public class LoteController {
    ...
    public String remover(Long codigo, Model model) {
        Optional<Lote> optVacina = loteRepository.findById(codigo);
        
        if(optVacina.isPresent()){
            Lote lote = optVacina.get();
